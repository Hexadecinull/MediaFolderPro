...
package.domain = io.github.ssmg4
source.dir = .
source.include_exts = py,png,jpg,kv,atlas,json
version = 2.0.1
requirements = python3,kivy==2.3.0,requests,beautifulsoup4,pillow,certifi,charset-normalizer,idna,urllib3,soupsieve,typing_extensions
